...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 07, 2025 at 09:48 AM
...
CREATE TABLE `task_table` (
  ...
  `file_attachment` varchar(500) NOT NULL,
...
INSERT INTO `task_table` (`id`, `task_name`, `task_description`, `task_instructions`, `due_date`, `status`, `assigned_to`, `created_by`, `created_at`, `updated_at`, `progress`, `file_attachment`, `admin_comments`) VALUES
(1, 'wake up and help us', 'sos', 'sos', '2024-12-21 00:00:00', 'Pending', 13, 1, '2024-12-19 20:06:31', '2024-12-19 20:06:31', 0, '', ''),
(2, 'daadwa', 'sdadwa', 'adadwas', '2024-12-03 00:00:00', 'Pending', 6, 1, '2024-12-19 20:18:53', '2024-12-19 20:18:53', 0, '', ''),
(3, 'Create a Business Letter', 'Create a business letter for the Tempest Company', 'Create a business letter for the Tempest Company', '2024-12-21 00:00:00', 'Pending', 13, 1, '2024-12-19 20:37:02', '2024-12-19 20:37:02', 0, '', ''),
(4, 'Create a Business Letter', 'test', 'test', '2024-12-21 00:00:00', 'Pending', 6, 1, '2024-12-19 22:12:53', '2024-12-19 22:12:53', 0, '', ''),
(5, 'Create a Business Letter', 'Create a Business Letter', 'Create a Business Letter', '2024-12-21 00:00:00', 'Pending', 11, 1, '2024-12-20 00:12:04', '2024-12-20 00:12:04', 0, '', ''),
(6, 'try', 'try', 'try', '2025-01-08 00:00:00', 'Pending', 11, 1, '2025-01-06 12:22:07', '2025-01-06 12:22:07', 0, '', ''),
(7, 'try', 'try', 'try', '2025-01-08 00:00:00', 'Pending', 11, 1, '2025-01-06 12:22:35', '2025-01-06 12:22:35', 0, '', ''),
(8, 'try', 'try', 'try', '2025-01-08 00:00:00', 'Pending', 11, 1, '2025-01-06 12:51:26', '2025-01-06 12:51:26', 0, '', ''),
(9, 'try', 'try', 'try', '2025-01-08 00:00:00', 'Pending', 11, 1, '2025-01-06 12:51:27', '2025-01-06 12:51:27', 0, '', ''),
(10, 'try', 'try', 'try', '2025-01-08 00:00:00', 'Pending', 11, 1, '2025-01-06 12:51:28', '2025-01-06 12:51:28', 0, '', ''),
(11, 'try', 'try', 'try', '2025-01-08 00:00:00', 'Pending', 11, 1, '2025-01-06 12:51:29', '2025-01-06 12:51:29', 0, '', ''),
(12, 'try', 'try', 'try', '2025-01-08 00:00:00', 'Pending', 13, 1, '2025-01-06 13:14:50', '2025-01-06 13:14:50', 0, '', ''),
(13, 'hi', 'hi', 'hi', '2025-01-09 00:00:00', 'Pending', 11, 1, '2025-01-06 17:04:19', '2025-01-06 17:04:19', 0, '', ''),
(14, 'test', 'test', 'test', '2025-01-09 00:00:00', 'Pending', 11, 1, '2025-01-06 17:19:25', '2025-01-06 17:19:25', 0, '', ''),
(15, 'new', 'new', 'new', '2025-01-20 00:00:00', 'Pending', 11, 1, '2025-01-06 19:40:24', '2025-01-06 19:40:24', 0, '', '');
...
(68, 11, 'tax id number.jpg', '../uploads/files/677ce3106abe2_tax id number.jpg', '2025-01-07 08:17:20', 'Tax Identification Number'),
(69, 11, 'signed employment contract.jpg', '../uploads/files/677ce3106b319_signed employment contract.jpg', '2025-01-07 08:17:20', 'Signed Employment Contract'),
(70, 11, 'resume.png', '../uploads/files/677ce31071a07_resume.png', '2025-01-07 08:17:20', 'Resume');
...
--
ALTER TABLE `task_comments`
  ADD CONSTRAINT `task_comments_ibfk_1` FOREIGN KEY (`task_id`) REFERENCES `task_table` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `task_comments_ibfk_2` FOREIGN KEY (`admin_id`) REFERENCES `admin` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `task_files`
--
ALTER TABLE `task_files`
  ADD CONSTRAINT `task_files_ibfk_1` FOREIGN KEY (`task_id`) REFERENCES `task_table` (`id`) ON DELETE CASCADE;
